...
To use our Android samples, you should first install [ESRC SDK for Android](https://github.com/esrc-official/ESRC-SDK-Android) 2.6.0 or higher on your system and should be received License Key by requesting by our email: **esrc@esrc.co.kr** <br /> 
